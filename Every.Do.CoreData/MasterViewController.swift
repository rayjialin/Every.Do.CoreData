...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        ...
        alertController.addAction(UIAlertAction(title: "Save", style: .default, handler: { (alert) in
            ...
            let priorityTextField = alertController.textFields![2] as UITextField
            newTodo.priority = priorityTextField.text ?? ""
        ...
        alertController.addTextField { (titleTextField: UITextField!) in
            if let defaultTitle = UserDefaults.standard.value(forKey: "todoTitle") as? String{
            titleTextField.placeholder = defaultTitle
            }
        }
        alertController.addTextField { (descriptionTextField: UITextField!) in
            if let defaultDescription = UserDefaults.standard.value(forKey: "todoDescription") as? String {
                descriptionTextField.placeholder = defaultDescription
            }
        }
        alertController.addTextField { (priorityTextField: UITextField!) in
            if let defaultPriority = UserDefaults.standard.value(forKey: "todoPriority") as? String {
                priorityTextField.placeholder = defaultPriority
            }
        }
